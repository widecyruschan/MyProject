{:$a1 = array_shift(article::data(2,1,0,$mycms['channel']['id'])):}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="frame_main">
		...
		<div class="content_common"><div class="content_menu"><div class="classify"><div class="left_title">{:$mycms['channel_titleEn']:}</div>{:foreach channel::navigation() as $n:} <a href="{:$n['URL']:}" target="{:$n['target']:}"{:if $mycms['channel_id'] == $n['id']:} class="active"{:/if:}>{:$n['title']:}</a> 
