<?php /* Smarty version Smarty-3.0.9, created on 2015-01-04 14:04:57
         compiled from "/Users/CyrusChan/Sites/zjbg/inc/templates/frontend/default/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:55125862554a8d80973cd41-93449437%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae23c0fb39ccafd91a924a6a73a3e31b7c0aa076' => 
    array (
      0 => '/Users/CyrusChan/Sites/zjbg/inc/templates/frontend/default/index.tpl',
      1 => 1417768970,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '55125862554a8d80973cd41-93449437',
  'function' => 
  array (
  ),
...
"><?php echo $_smarty_tpl->tpl_vars['n']->value['title'];?>
      ...
      </a><?php if (sizeof(channel::navigation($_smarty_tpl->tpl_vars['n']->value['id']))>0){?><ul class="children"> <?php  $_smarty_tpl->tpl_vars['s'] = new Smarty_Variable;
...
</a><?php if (sizeof(channel::navigation($_smarty_tpl->tpl_vars['s']->value['id']))>0){?><ul class="children"><?php  $_smarty_tpl->tpl_vars['a'] = new Smarty_Variable;
...
</a></li><?php }} ?></ul><?php }?></li><?php }} ?></ul><?php }?></li><?php }} ?></ul>
  </div>
</div>
<div id="focusBar" ><a href="javascript:void(0)" class="arrL" onclick="prePage()">&nbsp;</a><a href="javascript:void(0)" class="arrR" onclick="nextPage()">&nbsp;</a><?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable(1, null, null);?>
   <ul ><?php  $_smarty_tpl->tpl_vars['pic'] = new Smarty_Variable;
...
<div class="indexprolist"><div class="indelist"><div class="box" id="flash1"><div class="listtitle" id="til1"></div>
 ...
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
 $_from = article::data(0,3,0,25); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['a']->key => $_smarty_tpl->tpl_vars['a']->value){
