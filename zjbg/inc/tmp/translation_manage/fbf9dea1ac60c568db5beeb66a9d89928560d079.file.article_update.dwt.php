<?php /* Smarty version Smarty-3.0.9, created on 2014-05-11 21:16:32
         compiled from "/Library/WebServer/Documents/tf/inc/templates/manage/article_update.dwt" */ ?>
<?php /*%%SmartyHeaderCode:1034694805536f7830da1884-71655981%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fbf9dea1ac60c568db5beeb66a9d89928560d079' => 
    array (
      0 => '/Library/WebServer/Documents/tf/inc/templates/manage/article_update.dwt',
      1 => 1375008420,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1034694805536f7830da1884-71655981',
  'function' => 
  array (
  ),
...
" size="7" maxlength="7" class="input rounded iColorPicker" style="text-transform:uppercase;" /> &nbsp;&nbsp;&nbsp;
 ...
 &nbsp;
          ...
          <tr>
				<td class="name"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['backgroudColour'];?>
</td>
				<td>
				  <input id="backgroudColour" name="backgroudColour" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['article']['backgroudColour'];?>
" size="7" maxlength="7" class="input rounded iColorPicker" style="text-transform:uppercase;" /> &nbsp;&nbsp;&nbsp;
			</td>
				<td class="field">{:$a[<span class="name">'backgroudColour'</span>]:}</td>			
			</tr>
			<tr>
