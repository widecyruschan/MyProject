<?php /* Smarty version Smarty-3.0.9, created on 2015-11-18 15:43:00
         compiled from "/Users/cyrus/Sites/dmcc/inc/templates/manage/set_picture.dwt" */ ?>
<?php /*%%SmartyHeaderCode:216814569564c2c04b39e00-48318764%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cff6bad7c954f90c3bf5545d386974426d71a400' => 
    array (
      0 => '/Users/cyrus/Sites/dmcc/inc/templates/manage/set_picture.dwt',
      1 => 1401765827,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '216814569564c2c04b39e00-48318764',
  'function' => 
  array (
  ),
...
" <?php if (basename($_smarty_tpl->getVariable('mycms')->value['picture_config']['watermark']['truetype'])==$_smarty_tpl->tpl_vars['n']->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['n']->value;?>
			...
			<tr>
				<td class="name"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][25];?>
</td>
				<td>
					<input id="mycolor" name="watermark[color]" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture_config']['watermark']['color'];?>
" size="8" maxlength="7" class="iColorPicker" style="text-transform:uppercase; border:1px #CCC solid; height:20px; padding-left:3px;" />
				</td>
				<td class="field"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][26];?>
</td>
			</tr>
			<tr>
				<td class="name"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][27];?>
</td>
				<td>
					<input type="text" name="watermark[text]" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture_config']['watermark']['text'];?>
" size="30" />
				</td>
				<td class="field"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][28];?>
</td>
			</tr>
			<tr>
				<td class="name"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][29];?>
</td>
				<td>
					<input type="text" name="watermark[size]" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture_config']['watermark']['size'];?>
" size="5" />
				</td>
				<td class="field"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][30];?>
</td>
			</tr>
			<tr>
				<td class="name"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][31];?>
</td>
				<td>
					<input type="text" name="watermark[angle]" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture_config']['watermark']['angle'];?>
" size="5" />
				</td>
				<td class="field"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['watermark'][32];?>
</td>
			</tr>
		</table>
		...
		<?php if ($_smarty_tpl->getVariable('admin')->value['information']){?><div class="information rounded"><ol></ol>
			<?php echo $_smarty_tpl->getVariable('lang')->value['page']['information'][0];?>
<br />
			<?php echo $_smarty_tpl->getVariable('lang')->value['page']['information'][1];?>
<br />
			<?php echo $_smarty_tpl->getVariable('lang')->value['page']['information'][2];?>
<?php if ($_smarty_tpl->getVariable('mycms')->value['gd_info']['FreeType Support']){?><font color="#0000FF"><em><?php echo $_smarty_tpl->getVariable('lang')->value['page']['information'][5];?>
</em></font><?php }else{ ?><font color="#FF0000"><em><?php echo $_smarty_tpl->getVariable('lang')->value['page']['information'][6];?>
</em></font><?php }?><br />
			<?php echo $_smarty_tpl->getVariable('lang')->value['page']['information'][3];?>
<?php echo $_smarty_tpl->getVariable('mycms')->value['gd_info']['GD Version'];?>
<br />
			<?php echo $_smarty_tpl->getVariable('lang')->value['page']['information'][4];?>

		</div><?php }?>
		<?php if ($_smarty_tpl->getVariable('mycms')->value['preview_failed']==1){?><table class="table" cellpadding="0" border="0" cellspacing="0"><tr><td style="padding:0 0 15px 0;"><img src="<?php echo $_smarty_tpl->getVariable('mycms')->value['watermark_preview'];?>
?<?php echo time();?>
" border="0" /></td></tr></table><?php }?>
	</div>
