...
$language['page'] = array(
	...
	'static' => '首页静态部署：',
	'static_title' => '设置当前语言站首页静态生成和访问路径，相对于网站根目录路径，含完整文件名。<br />如：第一种语言设置为：<span class=\'green\'>index.html</span><br />　　第二种语言可以设置为： <span class=\'green\'>en/index.html</span> 或 <span class=\'green\'>index_2.html</span><br />如果设置的目录不存在程序会自动创建。',
	'webtitle' => '网站名称：',
	'logo' => '网站LOGO：',
	'keyword' => 'SEO关键字：',
