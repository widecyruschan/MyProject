<?php /* Smarty version Smarty-3.0.9, created on 2014-04-18 23:14:28
         compiled from "/Library/WebServer/Documents/inc/templates/frontend/default_wap/article.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157023511653514154331c74-65143036%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a80ec54b426c5c1140216bc0b619304a5fe43f1d' => 
    array (
      0 => '/Library/WebServer/Documents/inc/templates/frontend/default_wap/article.tpl',
      1 => 1390792493,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157023511653514154331c74-65143036',
  'function' => 
  array (
  ),
...
$(function(){
	...
	mycms.focus_classic('focus',3000,1,60); // 焦点图
}); 
</script>
</head>
<body>
...
<div class="classify"><?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable;
 $_from = category::data(1,$_smarty_tpl->getVariable('mycms')->value['channel']['id'],0,1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
');return false;}" />
 ...
 $_from = article::data(1,12,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
...
"><?php echo $_smarty_tpl->tpl_vars['a']->value['title_format'];?>
		...
		<div class="thumbnail">
			...
			<?php  $_smarty_tpl->tpl_vars['a'] = new Smarty_Variable;
 $_from = article::data(0,5,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id'],0,0,22,'',0,0,0,0,0,0,1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['a']->key => $_smarty_tpl->tpl_vars['a']->value){
?>
				<td>
...
" width="120" height="90" onload="mycms.img_auto_size(this)" /></a></div>
...
images/more.gif" width="42" height="20" /></a></ol>
				...
				<div class="circle">
				<?php  $_smarty_tpl->tpl_vars['a'] = new Smarty_Variable;
 $_from = article::data(0,10,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id'],$_smarty_tpl->tpl_vars['c']->value['id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['a']->key => $_smarty_tpl->tpl_vars['a']->value){
?>
...
" class="gen"><?php echo $_smarty_tpl->tpl_vars['t']->value['title'];?>
		...
		<div class="well">
			<?php  $_smarty_tpl->tpl_vars['a'] = new Smarty_Variable;
 $_from = article::data(0,10,1,$_smarty_tpl->getVariable('mycms')->value['channel']['id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['a']->key => $_smarty_tpl->tpl_vars['a']->value){
?>
			<ol><a href="<?php echo $_smarty_tpl->tpl_vars['a']->value['URL'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['a']->value['title_format'];?>
		...
		<div class="well">
			<?php  $_smarty_tpl->tpl_vars['a'] = new Smarty_Variable;
 $_from = article::data(5,10,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['a']->key => $_smarty_tpl->tpl_vars['a']->value){
?>
			<ol><a href="<?php echo $_smarty_tpl->tpl_vars['a']->value['URL'];?>
