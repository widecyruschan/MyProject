<?php /* Smarty version Smarty-3.0.9, created on 2014-04-18 23:28:43
         compiled from "/Library/WebServer/Documents/inc/templates/frontend/default_wap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:403065546535144ab227e93-88463712%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'afdd3179884ef2615dadccebd1352c2699cb5df0' => 
    array (
      0 => '/Library/WebServer/Documents/inc/templates/frontend/default_wap/product.tpl',
      1 => 1390792494,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '403065546535144ab227e93-88463712',
  'function' => 
  array (
  ),
...
$(function(){mycms.focus_classic('focus',3000,1,60);}); // 焦点图
</script>
</head>
<body>
...
<div class="classify"><?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable;
 $_from = category::data(2,$_smarty_tpl->getVariable('mycms')->value['channel']['id'],0,1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" class="gen"><?php echo $_smarty_tpl->tpl_vars['t']->value['title'];?>
	...
	<div class="frame_main">
		...
		<div class="recom">
			<?php $_smarty_tpl->tpl_vars['p'] = new Smarty_variable(product::data(0,20,1,$_smarty_tpl->getVariable('mycms')->value['channel']['id']), null, null);?>
...
" onload="mycms.img_auto_size(this)" width="100" height="100" alt="<?php echo $_smarty_tpl->getVariable('p')->value[$_smarty_tpl->tpl_vars['i']->value*5]['title'];?>
" /></a><?php }?></li>
				</ul>
				<ul class="text">
...
"><?php echo $_smarty_tpl->getVariable('p')->value[$_smarty_tpl->tpl_vars['x']->value+$_smarty_tpl->tpl_vars['i']->value*5]['title_format'];?>
		...
		<div class="recom">
			<?php $_smarty_tpl->tpl_vars['p'] = new Smarty_variable(product::data(1,30,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id']), null, null);?>
			<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->value = 0;
...
images/more.gif" width="42" height="20" /></a></ol>
		...
		<div class="recom">
			<?php $_smarty_tpl->tpl_vars['p'] = new Smarty_variable(product::data(0,10,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id'],$_smarty_tpl->tpl_vars['c']->value['id']), null, null);?>
			<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->value = 0;
...
"><?php echo $_smarty_tpl->getVariable('p')->value[$_smarty_tpl->tpl_vars['x']->value+$_smarty_tpl->tpl_vars['i']->value*5]['title_format'];?>
 ...
 $_from = product::data(13,10,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
...
"><?php echo $_smarty_tpl->tpl_vars['p']->value['title_format'];?>
		...
		<div class="well">
			<?php  $_smarty_tpl->tpl_vars['p'] = new Smarty_Variable;
 $_from = product::data(5,10,0,$_smarty_tpl->getVariable('mycms')->value['channel']['id']); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['p']->key => $_smarty_tpl->tpl_vars['p']->value){
?>
			<ol><a href="<?php echo $_smarty_tpl->tpl_vars['p']->value['URL'];?>
