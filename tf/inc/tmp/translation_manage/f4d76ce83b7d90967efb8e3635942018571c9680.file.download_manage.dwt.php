<?php /* Smarty version Smarty-3.0.9, created on 2013-07-09 16:04:27
         compiled from "/Users/cgc/Sites/mlecms/inc/templates/manage/download_manage.dwt" */ ?>
<?php /*%%SmartyHeaderCode:168816459251dbc40b67b203-41000968%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f4d76ce83b7d90967efb8e3635942018571c9680' => 
    array (
      0 => '/Users/cgc/Sites/mlecms/inc/templates/manage/download_manage.dwt',
      1 => 1344419154,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '168816459251dbc40b67b203-41000968',
  'function' => 
  array (
  ),
...
<?php }?><?php echo $_smarty_tpl->getVariable('mycms')->value['title_lang'];?>
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td><a href="download_manage.php?trash=0" class="basic_button" <?php if ($_smarty_tpl->getVariable('mycms')->value['get']['trash']==1){?>style="background:none;"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['manage'];?>
</a></td>
							<td><a href="download_manage.php?trash=1" class="advanced_button" <?php if ($_smarty_tpl->getVariable('mycms')->value['get']['trash']==1){?>style="background:url(../inc/templates/manage/images/switch_bg.png);"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['recycle'];?>
</a></td>
						</tr>
					</table>
				</td>
...
" /></td>
				...
				<?php if ($_smarty_tpl->getVariable('mycms')->value['channel_show']){?><td><a href="download_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
...
</span>/<span class="red"><?php echo $_smarty_tpl->tpl_vars['n']->value['count'];?>
</span></td>
				<td class="operation">
