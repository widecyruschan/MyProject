<?php /* Smarty version Smarty-3.0.9, created on 2014-04-10 20:41:35
         compiled from "/Library/WebServer/Documents/inc/templates/manage/template_language.dwt" */ ?>
<?php /*%%SmartyHeaderCode:10865474575346917f097fa5-54643081%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '954426af575af7c0e7945dc8efb730771514f12f' => 
    array (
      0 => '/Library/WebServer/Documents/inc/templates/manage/template_language.dwt',
      1 => 1374981480,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10865474575346917f097fa5-54643081',
  'function' => 
  array (
  ),
...
<div id="body_box">
 ...
 $_from = $_smarty_tpl->getVariable('mycms')->value['lang_dir']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['n']->key => $_smarty_tpl->tpl_vars['n']->value){
?>
								<option value="template_language.php?dir=<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
" <?php if ($_smarty_tpl->getVariable('mycms')->value['dir']==$_smarty_tpl->tpl_vars['n']->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['n']->value;?>
</option>
								<?php }} ?>
								</select>
							</td>
		...
		<table cellpadding="0" class="frame" cellspacing="0" border="0">
			<tr>
				<td class="field_head frame_right" height="30"><?php echo $_smarty_tpl->getVariable('mycms')->value['dir'];?>
...
<?php }else{ ?><?php echo $_smarty_tpl->getVariable('lang')->value['page'][5];?>
<?php }?>：</td>
						<td><a href="template_language.php?dir=<?php echo $_smarty_tpl->getVariable('mycms')->value['dir'];?>
...
/<?php echo $_smarty_tpl->getVariable('mycms')->value['file_name'];?>
		...
		<?php if ($_smarty_tpl->getVariable('admin')->value['information']){?><div class="information rounded"><ol></ol><?php echo $_smarty_tpl->getVariable('lang')->value['page'][8];?>
</div><?php }?>
	</div>
