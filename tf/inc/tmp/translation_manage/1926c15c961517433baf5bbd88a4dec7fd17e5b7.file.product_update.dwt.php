<?php /* Smarty version Smarty-3.0.9, created on 2013-07-09 17:09:43
         compiled from "/Users/cgc/Sites/mlecms/inc/templates/manage/product_update.dwt" */ ?>
<?php /*%%SmartyHeaderCode:93671643151dbd357d921c9-43682221%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1926c15c961517433baf5bbd88a4dec7fd17e5b7' => 
    array (
      0 => '/Users/cgc/Sites/mlecms/inc/templates/manage/product_update.dwt',
      1 => 1342749498,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '93671643151dbd357d921c9-43682221',
  'function' => 
  array (
  ),
...
var items = <?php echo $_smarty_tpl->getVariable('mycms')->value['product']['items_'];?>
; //图片张数
//图片配置缺省值，PHP字串转Js数组
var picture = new Array(<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['picture_config_js'];?>
); 
//修改时，多图片URL转成js数组
var picture_url = new Array(<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['picture_js'];?>
);
// 多图上传及裁切设置
// var ,1减，2加，其它参数没有变化
function sheets(val){
...
<?php echo $_smarty_tpl->getVariable('mycms')->value['title_lang'];?>
		...
		<table class="list" cellpadding="0" cellspacing="1" border="0">
			...
			<tr>
				...
				<td>
					<select class="select rounded" onchange="window.open(this.options[this.selectedIndex].value,'_self')" size="1"><?php echo $_smarty_tpl->getVariable('mycms')->value['product']['channel_text'];?>
...
"></a>								
			...
			<tr>
				...
				<td>
					<select name="category" id="category" class="select rounded" style="font-family:'Courier New',Courier,monospace;"><?php echo $_smarty_tpl->getVariable('mycms')->value['product']['nexus_text'];?>
</select> <span class="red">*</span>
...
"></a>
			...
			<tr>
				...
				<td>
					<input type="text" name="title" id="title" class="input rounded rule" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['title'];?>
" size="58" maxlength="255" /> <span class="red">*</span>
			...
			<tr>
				...
				<td>
					<input type="text" name="brief" class="input rounded rule" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['brief'];?>
...
">
			...
			<tr>
				...
				<td>
					<input name="virtual" type="radio" value="0"  <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['virtual']=='0'){?>checked<?php }?> /><?php echo $_smarty_tpl->getVariable('lang')->value['page']['virtual'][1];?>
 &nbsp;&nbsp;  
					<input name="virtual" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['virtual']=='1'){?>checked<?php }?> /><?php echo $_smarty_tpl->getVariable('lang')->value['page']['virtual'][2];?>
...
">				
 ...
 <input id="mycolor" name="color" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['color'];?>
" size="7" maxlength="7" class="input rounded iColorPicker" style="text-transform:uppercase;" /> &nbsp;&nbsp;&nbsp;
					<input name="bold" type="checkbox" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['bold']){?>checked="checked"<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['bold'];?>
 &nbsp;
				</td>
			...
			<tr>
				...
				<td><input name="model" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['model'];?>
" size="40"  maxlength="50" /></td>
			...
			<tr>
				...
				<td><input name="market" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['market'];?>
" size="7"  maxlength="10" /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['yuan'];?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('lang')->value['page']['price'];?>

					<input name="price" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['price'];?>
" size="7"  maxlength="10" /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['yuan'];?>
...
">				</td>
			...
			<tr>
				...
				<td><input name="inventory" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['inventory'];?>
" size="7" maxlength="10" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('lang')->value['page']['sales'];?>

			    <input name="sales" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['sales'];?>
" size="7" /></td>
			...
			<tr>
				...
				<td>
					<input name="units" id="units" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['units'];?>
" size="7" maxlength="20" /> 
 ...
 $_from = $_smarty_tpl->getVariable('mycms')->value['units_often']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"><?php echo $_smarty_tpl->tpl_vars['n']->value['units'];?>
			...
			<tr>
				...
				<td>
					<input name="tag" id="tag" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['tag'];?>
...
">
			...
			<tr>
				...
				<td><input name="keyword" id="keyword" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['keyword'];?>
" size="40" maxlength="100" /></td>
			...
			<tr>
				...
				<td>
					<textarea class="rounded" name="introduction" style="width:300px; height:50px; padding:5px;"><?php echo $_smarty_tpl->getVariable('mycms')->value['product']['introduction'];?>
</textarea>
...
">
			...
			<tr>
				...
				<td>
					<input name="page" type="radio" value="0"  <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['page']=='0'){?>checked<?php }?> /><?php echo $_smarty_tpl->getVariable('lang')->value['page']['page'][1];?>
 &nbsp;&nbsp;  
					<input name="page" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['page']=='1'){?>checked<?php }?> /><?php echo $_smarty_tpl->getVariable('lang')->value['page']['page'][2];?>
 &nbsp;&nbsp;
					<input name="page" type="radio" value="2" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['page']>1){?>checked<?php }?> id="auto_page" /><?php echo $_smarty_tpl->getVariable('lang')->value['page']['page'][3];?>

					<input name="page_size" type="text" maxlength="5" onclick="$('#auto_page').attr('checked','checked')" value="<?php if ($_smarty_tpl->getVariable('mycms')->value['product']['page']>1){?><?php echo $_smarty_tpl->getVariable('mycms')->value['product']['page'];?>
...
">
 ...
 <span class="field">{:$p['content']:}</span><br /><br />
					<textarea id="content" name="content"><?php echo $_smarty_tpl->getVariable('mycms')->value['product']['content'];?>
</textarea><br />
				</td>
			</tr>
		</table>
		...
		<table class="list" cellpadding="0" cellspacing="1" border="0">
			<tr>
				...
				<td colspan="3"><input name="brand" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['brand'];?>
" size="40" class="input rounded" maxlength="50" /></td>
			...
			<tr>
				...
				<td colspan="3"><input name="coding" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['coding'];?>
" size="40" class="input rounded" maxlength="50" /></td>
			...
			<tr>
				...
				<td colspan="3"><input name="speci" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['speci'];?>
" size="40" class="input rounded" maxlength="50" /></td>
			...
			<tr>
				...
				<td colspan="3">
					<input name="optional" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['optional'];?>
...
">
			...
			<tr>
				...
				<td colspan="3">
					<input name="template" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['template'];?>
...
">
			...
			<tr>
				...
				<td colspan="3">
					<input name="comment" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['comment']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['comment'][1];?>
 &nbsp;&nbsp;  
					<input name="comment" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['comment']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['comment'][2];?>
			...
			<tr>
				...
				<td colspan="3">
					<input name="recom" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['recom']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['recom'][1];?>
 &nbsp;&nbsp;  
					<input name="recom" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['recom']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['recom'][2];?>
			...
			<tr>
				...
				<td colspan="3">
					<input name="published" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['published']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['published'][1];?>
 &nbsp;&nbsp;  
					<input name="published" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['published']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['published'][2];?>
...
">
			...
			<tr>
				...
				<td colspan="3">
					<input name="status" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['status']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['status'][1];?>
 &nbsp;&nbsp;  
					<input name="status" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['status']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['status'][2];?>
...
">
			...
			<tr>
				...
				<td colspan="3">
					<input name="audit" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['audit']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['audit'][1];?>
 &nbsp;&nbsp;  
					<input name="audit" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['product']['audit']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['audit'][2];?>
			...
			<tr>
				...
				<td colspan="3">
					<select name="permission[]" class="rounded" style="width:205px; height:80px;" multiple id="select"><?php echo $_smarty_tpl->getVariable('mycms')->value['product']['permission_text'];?>
</select>				
...
">
			...
			<tr>
				...
				<td colspan="3">
					<input name="filename" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['filename'];?>
...
">
			...
			<tr>
				...
				<td><input name="click" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['click'];?>
" size="7" maxlength="10" /></td>
				<td class="name"><?php echo $_smarty_tpl->getVariable('lang')->value['page']['favorite'];?>
</td>
				<td><input name="favorite" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['favorite'];?>
" size="7" maxlength="10" /></td>
			...
			<tr>
				...
				<td>
					<input name="money" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['money'];?>
" size="7" maxlength="10" />
...
">
				...
				<td>
					<input name="integral" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['integral'];?>
" size="7" maxlength="10" />
...
">
			...
			<tr>
				...
				<td colspan="3">
					<textarea name="buyuser" style="width:300px; height:40px; padding:5px;" class="rounded"><?php echo $_smarty_tpl->getVariable('mycms')->value['product']['buyuser'];?>
</textarea>
...
">
			...
			<tr>
				...
				<td colspan="3">
					<input name="sort" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['sort'];?>
...
">
			...
			<tr>
				...
				<td colspan="3"><input name="addtime" type="text" class="input rounded" id="addtime" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['product']['addtime'];?>
