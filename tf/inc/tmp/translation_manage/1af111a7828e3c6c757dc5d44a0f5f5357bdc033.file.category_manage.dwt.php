<?php /* Smarty version Smarty-3.0.9, created on 2013-07-20 17:50:31
         compiled from "/Users/cgc/Sites/mlecms/inc/templates/manage/category_manage.dwt" */ ?>
<?php /*%%SmartyHeaderCode:197368368151ea5d67a6b3b2-88502342%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1af111a7828e3c6c757dc5d44a0f5f5357bdc033' => 
    array (
      0 => '/Users/cgc/Sites/mlecms/inc/templates/manage/category_manage.dwt',
      1 => 1344393622,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '197368368151ea5d67a6b3b2-88502342',
  'function' => 
  array (
  ),
...
<?php echo $_smarty_tpl->getVariable('mycms')->value['title_lang'];?>
 ...
 $_from = $_smarty_tpl->getVariable('mycms')->value['channel']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"></a>
					<a href="category_update.php?id=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
...
"></a>
					<a href="category_manage.php?module=<?php echo $_smarty_tpl->tpl_vars['n']->value['module'];?>
...
px;">
 ...
 $_from = $_smarty_tpl->getVariable('mycms')->value['category'][$_smarty_tpl->tpl_vars['n']->value['id']]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
