<?php /* Smarty version Smarty-3.0.9, created on 2014-05-10 16:22:10
         compiled from "/Library/WebServer/Documents/tf/inc/templates/manage/picture_update.dwt" */ ?>
<?php /*%%SmartyHeaderCode:1055406906536de1b2cf1638-96486840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '76a2d8d1e51706bd0e2da457d72cb5f6bdce1249' => 
    array (
      0 => '/Library/WebServer/Documents/tf/inc/templates/manage/picture_update.dwt',
      1 => 1374981480,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1055406906536de1b2cf1638-96486840',
  'function' => 
  array (
  ),
...
var items = <?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['items_'];?>
; //图片张数
//图片配置缺省值，PHP字串转Js数组
var picture = new Array(<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['picture_config_js'];?>
); 

//修改时，多图片URL转成js数组
var picture_url = new Array(<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['picture_js'];?>
);

//修改时，图片描述转成js数组
var description = new Array(<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['description_js'];?>
);

//修改时，图片预览URL转换
var img_html = new Array(<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['img_html_js'];?>
);
...
');
	...
	if($('#aid').val() != '' && $('#aid').val().match(/^[a-zA-Z][a-zA-Z0-9_]{3,20}$/) == null){
		mycms.top_error('<?php echo $_smarty_tpl->getVariable('lang')->value['page']['code_warning'];?>
');
		top_error_isshow = true;
		return false;		
	}
...
<?php echo $_smarty_tpl->getVariable('mycms')->value['title_lang'];?>
		...
		<table class="list" cellpadding="0" cellspacing="1" border="0">
			...
			<tr>
				...
				<td>
					<select class="select rounded" onchange="window.open(this.options[this.selectedIndex].value,'_self')" size="1"><?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['channel_text'];?>
...
"></a>								
			...
			<tr>
				...
				<td>
					<input type="text" name="title" id="title" class="input rounded rule" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['title'];?>
" size="58" maxlength="255" /> <span class="red">*</span>
			...
			<tr>
				...
				<td>
					<input type="text" name="brief" class="input rounded rule" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['brief'];?>
...
">
 ...
 <input id="mycolor" name="color" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['color'];?>
" size="7" maxlength="7" class="input rounded iColorPicker" style="text-transform:uppercase;" /> &nbsp;&nbsp;&nbsp;
					<input name="bold" type="checkbox" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['picture']['bold']){?>checked="checked"<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['bold'];?>
 &nbsp;
				</td>
			...
			<tr>
				...
				<td>
					<input name="aid" id="aid" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['aid'];?>
...
">
			...
			<tr>
				...
				<td>
					<input name="tag" id="tag" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['tag'];?>
...
">
			...
			<tr>
				...
				<td><input name="keyword" id="keyword" type="text" class="input rounded" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['keyword'];?>
...
"><br /><br />
					<textarea id="content" name="content"><?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['content'];?>
</textarea><br />
				</td>
			</tr>
		</table>
		...
		<table class="list" cellpadding="0" cellspacing="1" border="0">
			<tr>
				...
				<td><input name="author" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['author'];?>
" size="40" class="input rounded" maxlength="50" /></td>
			...
			<tr>
				...
				<td><input name="source" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['source'];?>
" size="40" class="input rounded" maxlength="50" /></td>
			...
			<tr>
				...
				<td><input name="sourceurl" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['sourceurl'];?>
" size="40" class="input rounded" maxlength="50" /></td>
			...
			<tr>
				...
				<td>
					<input name="template" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['template'];?>
...
">
			...
			<tr>
				...
				<td>
					<input name="comment" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['picture']['comment']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['comment'][1];?>
 &nbsp;&nbsp;  
					<input name="comment" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['picture']['comment']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['comment'][2];?>
			...
			<tr>
				...
				<td>
					<input name="recom" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['picture']['recom']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['recom'][1];?>
 &nbsp;&nbsp;  
					<input name="recom" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['picture']['recom']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['recom'][2];?>
			...
			<tr>
				...
				<td>
					<input name="audit" type="radio" value="1" <?php if ($_smarty_tpl->getVariable('mycms')->value['picture']['audit']=='1'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['audit'][1];?>
 &nbsp;&nbsp;  
					<input name="audit" type="radio" value="0" <?php if ($_smarty_tpl->getVariable('mycms')->value['picture']['audit']=='0'){?>checked<?php }?> /> <?php echo $_smarty_tpl->getVariable('lang')->value['page']['audit'][2];?>
			...
			<tr>
				...
				<td>
					<select name="permission[]" class="rounded" style="width:205px; height:80px;" multiple id="select"><?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['permission_text'];?>
</select>				
...
">
			...
			<tr>
				...
				<td>
					<input name="filename" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['filename'];?>
...
">
			...
			<tr>
				...
				<td><input name="click" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['click'];?>
" size="20" maxlength="10" /></td>
			...
			<tr>
				...
				<td>
					<input name="money" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['money'];?>
...
">
			...
			<tr>
				...
				<td>
					<input name="integral" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['integral'];?>
" size="20" maxlength="10" />
...
">
			...
			<tr>
				...
				<td>
					<textarea name="buyuser" style="width:300px; height:40px; padding:5px;" class="rounded"><?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['buyuser'];?>
</textarea>
...
">
			...
			<tr>
				...
				<td>
					<input name="sort" class="input rounded" type="text" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['sort'];?>
" size="20" maxlength="10" />
...
">
			...
			<tr>
				...
				<td><input name="addtime" type="text" class="input rounded" id="addtime" value="<?php echo $_smarty_tpl->getVariable('mycms')->value['picture']['addtime'];?>
