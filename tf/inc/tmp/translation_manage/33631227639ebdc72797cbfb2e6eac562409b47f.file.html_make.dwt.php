<?php /* Smarty version Smarty-3.0.9, created on 2013-07-09 16:04:37
         compiled from "/Users/cgc/Sites/mlecms/inc/templates/manage/html_make.dwt" */ ?>
<?php /*%%SmartyHeaderCode:6312846551dbc4159e4348-91348837%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33631227639ebdc72797cbfb2e6eac562409b47f' => 
    array (
      0 => '/Users/cgc/Sites/mlecms/inc/templates/manage/html_make.dwt',
      1 => 1344393622,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6312846551dbc4159e4348-91348837',
  'function' => 
  array (
  ),
...
$(function(){
	...
	mycms.keysubmit('form_html','submit',true);
});
// 全选、取消全选
...
<?php echo $_smarty_tpl->getVariable('mycms')->value['title_lang'];?>
		...
		<?php if ($_smarty_tpl->getVariable('mycms')->value['show_status']=='make'){?><!-- 显示进度及操作按钮 -->
			...
			<tr>
				<td height="40" valign="top">
					<table>
						<tr>
							<?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('mycms')->value['other_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['n']->key => $_smarty_tpl->tpl_vars['n']->value){
?>
						...
						<tr>
							...
							<td>
								<select name="content_module" class="select rounded">
									<?php  $_smarty_tpl->tpl_vars['n'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('mycms')->value['content_module']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['n']->key => $_smarty_tpl->tpl_vars['n']->value){
...
<?php if ($_smarty_tpl->getVariable('mycms')->value['show_status']=='make'){?>
