<?php /* Smarty version Smarty-3.0.9, created on 2013-07-10 15:39:58
         compiled from "/Users/cgc/Sites/mlecms/inc/templates/manage/ad_manage.dwt" */ ?>
<?php /*%%SmartyHeaderCode:8128192351dd0fceea53d6-25024567%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'faf4606f1dbc07703047a42d1cf7ea2b182fee40' => 
    array (
      0 => '/Users/cgc/Sites/mlecms/inc/templates/manage/ad_manage.dwt',
      1 => 1344393621,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8128192351dd0fceea53d6-25024567',
  'function' => 
  array (
  ),
...
<?php echo $_smarty_tpl->getVariable('mycms')->value['title_lang'];?>
 ...
 $_from = $_smarty_tpl->getVariable('mycms')->value['ad_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" /><?php }?></td>
 ...
 <!-- 永不过期 -->
					<?php }elseif($_smarty_tpl->tpl_vars['n']->value['end']<$_smarty_tpl->getVariable('mycms')->value['gmt_time']){?><span class="blue"><?php echo $_smarty_tpl->getVariable('lang')->value['page'][13];?>
</span> <!-- 已过期 -->
					<?php }elseif($_smarty_tpl->tpl_vars['n']->value['start']>$_smarty_tpl->getVariable('mycms')->value['gmt_time']){?><span class="green"><?php echo $_smarty_tpl->getVariable('lang')->value['page'][14];?>
</span> <!-- 还没开始 -->
					<?php }else{ ?><?php echo (($_smarty_tpl->getVariable('lang')->value['page'][15]).(ceil(($_smarty_tpl->tpl_vars['n']->value['end']-$_smarty_tpl->getVariable('mycms')->value['gmt_time'])/86400))).($_smarty_tpl->getVariable('lang')->value['page'][16]);?>
 <!-- 正常范围内 -->
					<?php }?>
				</td>
				<td class="operation">
					<?php if ($_smarty_tpl->tpl_vars['n']->value['enable']){?><a href="ad_manage.php?page=<?php echo $_smarty_tpl->getVariable('mycms')->value['dpage'];?>
...
" /></a><?php }else{ ?><a href="ad_manage.php?page=<?php echo $_smarty_tpl->getVariable('mycms')->value['dpage'];?>
...
" /></a>
					<a href="ad_manage.php?page=<?php echo $_smarty_tpl->getVariable('mycms')->value['dpage'];?>
