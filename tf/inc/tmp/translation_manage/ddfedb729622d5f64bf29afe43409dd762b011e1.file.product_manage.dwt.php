<?php /* Smarty version Smarty-3.0.9, created on 2013-07-09 16:04:32
         compiled from "/Users/cgc/Sites/mlecms/inc/templates/manage/product_manage.dwt" */ ?>
<?php /*%%SmartyHeaderCode:21012807351dbc4101670b0-72012183%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ddfedb729622d5f64bf29afe43409dd762b011e1' => 
    array (
      0 => '/Users/cgc/Sites/mlecms/inc/templates/manage/product_manage.dwt',
      1 => 1344393623,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21012807351dbc4101670b0-72012183',
  'function' => 
  array (
  ),
...
','restore',false);
	mycms.acsubmit('manage','status','<?php echo $_smarty_tpl->getVariable('lang')->value['page']['determine'][9];?>
','status',false);
	mycms.acsubmit('manage','unstatus','<?php echo $_smarty_tpl->getVariable('lang')->value['page']['determine'][10];?>
','unstatus',false);
});
</script>
</head>
...
<?php }?><?php echo $_smarty_tpl->getVariable('mycms')->value['title_lang'];?>
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td><a href="product_manage.php?trash=0" class="basic_button" <?php if ($_smarty_tpl->getVariable('mycms')->value['get']['trash']==1){?>style="background:none;"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['manage'];?>
</a></td>
							<td><a href="product_manage.php?trash=1" class="advanced_button" <?php if ($_smarty_tpl->getVariable('mycms')->value['get']['trash']==1){?>style="background:url(../inc/templates/manage/images/switch_bg.png);"<?php }?>><?php echo $_smarty_tpl->getVariable('lang')->value['page']['recycle'];?>
</a></td>
						</tr>
					</table>
				</td>
...
" /></td>
				...
				<?php if ($_smarty_tpl->getVariable('mycms')->value['channel_show']){?><td><a href="product_manage.php?channel=<?php echo $_smarty_tpl->tpl_vars['n']->value['channel'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['n']->value['category_title'];?>
				...
				<td style="text-align:left;">
					<a target="_blank" href="../detail.php?id=<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
...
</span>/<span class="green"><?php echo $_smarty_tpl->tpl_vars['n']->value['commenttotal'];?>
</span>/<span class="red"><?php echo $_smarty_tpl->tpl_vars['n']->value['sales'];?>
</span></td>
				<td class="operation">
...
" /></a><?php }?>
					<?php if ($_smarty_tpl->tpl_vars['n']->value['status']){?><a href="<?php echo $_smarty_tpl->getVariable('mycms')->value['op_url'];?>
