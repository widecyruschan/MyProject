...
<div class="frame_main">
		...
		<div class="content_common"><div class="content_menu"><div class="classify"><div class="left_title">{:$mycms['channel']['titleEn']:}</div>{:foreach channel::navigation() as $n:} <a href="{:$n['URL']:}" target="{:$n['target']:}" >{:$n['title']:}</a> 
